		...
		map[string]StepSchema{
			...
			"cicd": {
				...
				Options: []Item{
					{
						Title: "Jenkins",
						Desc:  "Jenkins pipeline with Dockerfile for automating tests, building images, and pushing them to DockerHub",
					},

					{
						Title: "Github-Action",
						Desc:  "Github Action pipline with releaser, linting and code testing",
					},
